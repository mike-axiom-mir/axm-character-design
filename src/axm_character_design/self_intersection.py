...
This Character-local receiving implementation re-tests the same small geometric
method against Character shoulder geometry. No Animal source semantics or PASS
is inherited, and this file is not a Universal Creation extraction.
...
DONOR_PROVENANCE = {
    ...
    "reuse": "bounded geometric-method precedent only; Character re-tests locally",
}
